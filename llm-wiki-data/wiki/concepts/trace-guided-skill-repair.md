...
> 来源：[[sources/zotero-users-0-5RKUKLBV|Evolving Programmatic Skill Networks]]；PDF pp. 3–4，19–21，Algorithm 1。
...
关联：[[concepts/programmatic-skill-network|程序化技能网络（PSN）]]、[[concepts/validated-structural-refactoring|可验证的结构重构]]。
